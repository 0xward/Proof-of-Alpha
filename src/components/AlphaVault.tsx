...
// cUSD (now rebranded to USDm) and USDT first — MiniPay users primarily hold stablecoins
const VAULT_ASSET_LIST = [
  {
    ...
    minSupply: 1,
    // cUSD rebranded to USDm (Mento Dollar) — same contract, new name & logo
    displayName: 'USDm',
    logo: 'https://raw.githubusercontent.com/trustwallet/assets/master/blockchains/celo/assets/0x765DE816845861e75A25fCA122bb6898B8B1282a/logo.png',
    miniPayFeatured: true,
  },
  {
    ...
    minSupply: 1,
    displayName: 'USDT',
    logo: 'https://raw.githubusercontent.com/trustwallet/assets/master/blockchains/celo/assets/0x48065fbBE25f71C9282ddf5e1cD6D6A887483D5e/logo.png',
    miniPayFeatured: true,
  },
  {
    ...
    minSupply: 1,
    displayName: 'CELO',
    logo: 'https://raw.githubusercontent.com/trustwallet/assets/master/blockchains/celo/assets/0x471EcE3750Da237f93B8E339c536989b8978a438/logo.png',
    miniPayFeatured: false,
  },
  {
    ...
    minSupply: 1,
    displayName: 'USDC',
    logo: 'https://raw.githubusercontent.com/trustwallet/assets/master/blockchains/celo/assets/0xcebA9300f2b948710d2653dD7B07f33A8B32118C/logo.png',
    miniPayFeatured: false,
  },
  {
...
export function AlphaVault() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 font-mono space-y-6">
      ...
      {/* ── MINIPAY STABLECOIN BANNER ────────────────────────────────────── */}
      <div className="border border-emerald-500/25 bg-emerald-500/5 px-4 py-3 flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="text-[10px] font-black uppercase tracking-widest text-emerald-400 mb-0.5">
            EARN WITH YOUR USDm &amp; USDT
          </div>
          <div className="text-[9px] text-emerald-400/50 uppercase tracking-widest">
            Supply your stablecoins to Aave V3 on Celo — earn DeFi yield + daily $PROOF points. Withdraw anytime.
          </div>
        </div>
        <div className="flex gap-1.5 flex-shrink-0">
          {['USDm', 'USDT'].map(s => (
            <span key={s} className="text-[9px] font-black text-emerald-400 border border-emerald-400/30 bg-emerald-400/10 px-2 py-0.5 uppercase">
              {s}
            </span>
          ))}
        </div>
        ...
        {VAULT_ASSET_LIST.map(asset => {
          ...
          return (
            ...
            >
              ...
              <div className={`text-[10px] font-black ${asset.color}`}>{asset.displayName ?? asset.symbol}</div>
              {apyLoading ? (
          ...
          VAULT_ASSET_LIST.map(asset => {
            ...
            return (
              <div key={asset.symbol} className="flex items-center gap-1.5">
                ...
                <span className={`text-[9px] font-black ${asset.color}`}>{asset.displayName ?? asset.symbol}</span>
      ...
      <div className={`border ${selectedAsset.bg.replace('/10','/5')} border-[#FFB800]/20 px-4 py-3 flex items-center gap-3`}>
        ...
        <div className="flex-1">
          <div className={`text-sm font-black ${selectedAsset.color}`}>{selectedAsset.displayName ?? selectedAsset.symbol}</div>
