...
export function ForensicTerminal() {
  const [txHash, setTxHash] = useState<string>(() => localStorage.getItem('poa_draft_tx') || '');
        ...
        <div className="flex flex-col md:flex-row gap-3">
          <div className="flex-1 bg-[#050505] flex items-center px-4 rounded-lg border border-[#FFB800]/10 focus-within:border-[#FFB800]/40 transition-colors">
            ...
            <input
              ...
              value={txHash}
              onChange={(e) => { setTxHash(e.target.value); localStorage.setItem('poa_draft_tx', e.target.value); }}
          ...
          >
            ...
            >
              ...
              <div className="w-full flex gap-3">
                <button
                  onClick={handleShare}
                  className="flex-1 py-3 border border-[#FFB800]/40 text-[#FFB800] font-black uppercase tracking-widest text-xs hover:bg-[#FFB800]/10 active:scale-95 transition-all flex items-center justify-center gap-2"
                >
