...
const FALLBACK_ASSETS = [
  { symbol: 'USDC', name: 'USD Coin',       supplyAPY: 4.82, borrowAPY: 7.21, tvlUSD: 3_420_000, utilization: 78, logo: 'https://assets.coingecko.com/coins/images/6319/small/usdc.png' },
  { symbol: 'CELO', name: 'Celo',           supplyAPY: 2.14, borrowAPY: 4.87, tvlUSD: 2_190_000, utilization: 52, logo: 'https://assets.coingecko.com/coins/images/11090/small/InjXBNx9_400x400.jpg' },
  { symbol: 'USDT', name: 'Tether USD',     supplyAPY: 5.11, borrowAPY: 8.03, tvlUSD: 1_870_000, utilization: 81, logo: 'https://assets.coingecko.com/coins/images/325/small/Tether.png' },
  { symbol: 'WETH', name: 'Wrapped Ether',  supplyAPY: 1.93, borrowAPY: 3.44, tvlUSD: 980_000,  utilization: 45, logo: 'https://assets.coingecko.com/coins/images/2518/small/weth.png' },
  { symbol: 'cUSD', name: 'Celo Dollar',    supplyAPY: 3.77, borrowAPY: 6.22, tvlUSD: 750_000,  utilization: 69, logo: 'https://assets.coingecko.com/coins/images/13161/small/icon-celo-dollar-reversed-400x400.png' },
];

// Token logo map (Aave V3 Celo known assets)
const TOKEN_LOGOS: Record<string, string> = {
  ...
  cUSD:  'https://assets.coingecko.com/coins/images/13161/small/icon-celo-dollar-reversed-400x400.png',
          ...
          <div className="border border-[#B6509E]/40 bg-[#B6509E]/5 px-6 py-4 text-right relative overflow-hidden">
            ...
            {topAsset && (
              <div className="text-[9px] text-[#FFB800]/50 font-mono mt-1">
                BEST APY: {topAsset.symbol} @ <span className="text-green-400 font-bold">{topAPY.toFixed(2)}%</span>
              </div>
            )}
          </div>
        </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <div>
                      <div className="text-xs font-black text-[#FFB800] tracking-wider">{asset.symbol}</div>
                      <div className="text-[8px] text-[#FFB800]/30 uppercase tracking-widest truncate max-w-[80px]">{asset.name}</div>
                    </div>
                  </div>
