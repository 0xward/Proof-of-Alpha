...
export function LandingPage({ onEnter }: LandingPageProps) {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-[#FFB800] font-mono">
      {/* CRT overlay */}
      ...
      <section className="min-h-screen flex flex-col items-center justify-center px-4 pt-20 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          <div className="inline-flex items-center gap-2 border border-[#FFB800]/30 px-4 py-1.5 text-[10px] uppercase tracking-widest text-[#FFB800]/60 mb-8">
            ...
            Built on Celo • Powered by Groq AI • V2.0.0
          </div>
          ...
          <p className="text-[10px] text-[#FFB800]/25 uppercase tracking-widest">
            TERMINAL_V2.0.0 // CELO_MAINNET // AI_ENGINE: GROQ_LLAMA_3.3_70B
          </p>
        </div>
      ...
      <footer className="border-t border-[#FFB800]/20 py-8 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <div className="text-[10px] font-mono text-white/30 tracking-widest mb-4 uppercase">
            © 2026 PROOF OF ALPHA // TERMINAL_V2.0.0 // CELO_MAINNET // AAVE_V3
          </div>
          <div className="flex justify-center gap-6 text-[10px] font-mono text-white/25 uppercase tracking-widest flex-wrap">
            ...
            <a href="mailto:support@proofofal.pha" className="hover:text-[#FFB800] transition-colors">SUPPORT</a>
